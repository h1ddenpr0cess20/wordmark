...
- **Tests** — coverage for the Party prompt builders (persona/first/subsequent-turn/decision prompts, user-name-keyed interjection detection) and scenario/config defaults.

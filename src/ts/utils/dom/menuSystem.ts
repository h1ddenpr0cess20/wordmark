...
import agentHtml from "../../../html/panels/settings/agent.html?raw";
...
const PANEL_HTML = {
  ...
  "src/html/panels/settings/agent.html": agentHtml,
...
const SETTINGS_TAB_PARTIALS = [
  ...
  { filePath: "src/html/panels/settings/agent.html", containerId: "content-agent" },

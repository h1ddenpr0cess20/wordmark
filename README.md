...
- **Prompt queuing** — type while a response is still streaming and the message is held rather than dropped; it is handed to the running turn at its next tool call, or sent as the next turn otherwise ([UI and UX](docs/ui-and-ux.md#prompt-queuing))
